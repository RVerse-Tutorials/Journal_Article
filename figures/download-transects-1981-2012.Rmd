...
We will use the SST, Pathfinder Ver 5.2 (L3C), Day, Global, 0.0417°, 1981-2012, Science Quality (Monthly Composite). 0.0417 degrees is 4.63km approx.  This is the 'erdPH2sstdmday' dataset on the ERDDAP server. 
...
for(i in 1:length(thedate)){
  ...
  if(i %% 12) save(meanmat, file=filename)
}
save(meanmat, file=filename)
