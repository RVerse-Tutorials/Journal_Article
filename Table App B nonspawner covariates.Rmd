...
#set up table
seltable = data.frame(
  Model=paste("M1 ", Yr1,"-", Yr2, " data", sep=""), 
  Residual.df="", 
  MASE="",
  Adj.R2="", 
  F="", 
...
aa = summary(get(mod))
tmp1=data.frame(
  Model="2. $ln(N_t)$ = M1 + $\\beta V_t$ + $\\epsilon$",
  Residual.df=round(a[["Resid. Df"]][i],digits=1), 
  MASE=round(mean(abs(residuals(get(mod))))/NE,digits=3), 
  Adj.R2=100*round(aa$r.sq, digits=3), 
...
aa = summary(get(mod))
tmp1=data.frame(
  Model="3. $ln(N_t)$ = M1 + $s(V_t)$ + $\\epsilon$",
  Residual.df=round(a[["Resid. Df"]][i],digits=1), 
  MASE=round(mean(abs(residuals(get(mod))))/NE,digits=3), 
  Adj.R2=100*round(aa$r.sq, digits=3), 
  F=round(a$F[i],digits=2), p.value = round(a[["Pr(>F)"]][i], digits=3), 
...
aa = summary(get(mod))
tmp1=data.frame(
  Model="4. $ln(N_t)$ = M1 + $\\beta V_{t-1}$ + $\\epsilon$", 
  Residual.df=round(a[["Resid. Df"]][i],digits=1), 
  MASE=round(mean(abs(residuals(get(mod))))/NE,digits=3), 
  Adj.R2=100*round(aa$r.sq, digits=3), 
  F=round(a$F[i],digits=2), p.value = round(a[["Pr(>F)"]][i], digits=3), 
...
aa = summary(get(mod))
tmp1=data.frame(
  Model="5. $ln(N_t)$ = M1 + $s(ln(S_{t-2}))$ + $s(V_{t-1})$ + $\\epsilon$", 
  Residual.df=round(a[["Resid. Df"]][i],digits=1), 
  MASE=round(mean(abs(residuals(get(mod))))/NE,digits=3), 
  Adj.R2=100*round(aa$r.sq, digits=3), 
  F=round(a$F[i],digits=2), p.value = round(a[["Pr(>F)"]][i], digits=3), 
