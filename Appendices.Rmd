---
title: "Appendices: Use of satellite data for understanding and predicting oil sardine (*Sardinella longiceps*) catch variability along the southwest coast of India"
...
# Appendix A: Tests for the structure of the Qtr 3 and non-Qtr 3 catch models
...
# Appendix B: Model selection for the covariates

```{r, results="asis", echo=FALSE}
cat("\\clearpage")
```

# Appendix C: Correlation of covariates across the boxes

```{r cov-correlation, fig.cap="Correlation of the covariates across boxes.  Correlation is shown by the width of the lines between neighboring boxes.",fig.width=6,fig.height=8.5,message=FALSE,warning=FALSE, echo=FALSE}
library(maps)
library(mapdata)
