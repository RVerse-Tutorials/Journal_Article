...
```{r child = file.path('SupplementFiles', 'Table App B spawner covariates.Rmd')}
```
...
```{r child = file.path('SupplementFiles', 'Table App B nonspawner covariates M with S2.Rmd')}
```
...
```{r child = file.path('SupplementFiles', 'Table App B nonspawner covariates M wo S2.Rmd')}
```
...
```{r child = file.path('SupplementFiles', 'Table App C chlorophyll.Rmd')}
```
