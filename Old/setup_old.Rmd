...
respdat=respdat[respdat$Year<=max(seio_covariates_mon$Year),]
  ...
  covnames=c(
   ...
   "ONI","DMI","Bakun.UPW", "Precip.Kerala")
  covmon=list(
     7:9,7:9,7:9,7:9,
     1:3,1:3,1:3,1:3,
...
for(i in c("2.5", "2.10", "7.10", "11.13")){
tmp=(respdat[,paste0("SST.",i,".mon1to12.0")]*12 -
     respdat[,paste0("SST.",i,".mon10to12.0")]*3 -
     respdat[,paste0("SST.",i,".mon7to9.0")]*3) +
     respdat[,paste0("SST.",i,".mon1to12.1")]*12 +
     respdat[,paste0("SST.",i,".mon1to12.2")]*12
varname=paste0("SST.",i,".3.yr.runsum.0")
respdat[[varname]]=tmp/(12+12+6)
#create the lag 1
for(ii in paste0("SST.",i,".3.yr.runsum.0")){
...
covnames = c("precip.gpcp.kerala.mon6to7.", "precip.gpcp.kerala.mon4to5.", 
             ...
             "SST.2.5.3.yr.runsum.", "SST.2.10.3.yr.runsum.",
             "SST.11.13.3.yr.runsum.", "SST.7.10.3.yr.runsum.",
...
dat=fullrespdat[,c("Year","nspawners1", "nspawners2", "spawners0", "spawners1", "spawners2", paste(covnames, "0", sep=""), paste(covnames, "1", sep=""))]
dat=na.omit(dat)
dat.spawners=dat
