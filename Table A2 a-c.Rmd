...
colnames(seltable)=c("Model", "Residual df", "Residual deviance", "F", "p value", "AIC")
kable(seltable, align="lccccc", caption="Table A2b. Model selection tests of time-dependency the $NS_t$ model using non-linear responses instead of linear responses as in Table A2a.  See Table A2a for explanation of the parameters and model set-up.")
```
...
colnames(seltable)=c("Model", "Residual df", "Residual deviance", "F", "p value", "AIC")
kable(seltable, align="lccccc", caption="Table A2c. Model selection tests of time-dependency for the $NS_t$ model using 1956-2015 data.")
```
