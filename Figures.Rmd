...
### FIGURE covariates
oldpar=par(mfrow=c(2,2), mar=c(2,5,2,1))
i=4
...
plot(m1, select=2, xlab=xl, ylab="Effect")
#legend("topright","A", bty="n")
legend("topleft","Jul-Sep catch", bty="n")
abline(h=0, col="grey")
plot(m2, select=2, xlab="Jun-Sep SST-derived upwelling index", ylab="Effect")
#legend("topright","B", bty="n")
#abline(v=0, col="blue")
abline(h=0, col="grey")
legend("topleft","Jul-Sep catch", bty="n")
...
xl <- expression("2.5-year average SST ("*degree*"C)")
plot(m1, select=3, xlab=xl, ylab="Effect")
#legend("topright","C", bty="n")
legend("topleft","Oct-Mar catch", bty="n")
abline(h=0, col="grey")
plot(m2, select=3, xlab="Jun-Sep SST-derived upwelling index", ylab="Effect")
#legend("topright","D", bty="n")
legend("topleft","Oct-Mar catch", bty="n")
abline(h=0, col="grey")
#abline(v=0, col="blue")
...
text(par('usr')[1], par('usr')[4]-2*val, pos=4, labels="Without 2.5-year average SST")
legend("topright","a", bty="n")
...
r2 <- round(100*summary(m1)$r.sq,digits=1)
