...
```{r fig-study-area, out.width = "350px", fig.align='center', echo=FALSE, fig.cap=thecap, message=FALSE, warning=FALSE, eval=FALSE}
...
```{r fitted-loo, echo=FALSE,fig.cap=paste("Figure",  ref("fig:fitted")), fig.width=8,fig.height=8,message=FALSE,warning=FALSE}
