...
Yr1 = min(dat$Year)
Yr2 = max(dat$Year)
covnames=c("SST.2.10.3.yr.runsum.0", "SST.UPW.4.mon6to9.0")
covtits =  c("3-yr average SST", "Jul-Sep UPW current season")
...
plot(m1, select=2, xlab="2.5-year ave. SST", ylab="Effect")
legend("topright","A", bty="n")
legend("topleft","Jul-Sep Catch", bty="n")
abline(h=0, col="grey")
plot(m2, select=2, xlab="Jun-Sep upwelling index", ylab="Effect")
legend("topright","B", bty="n")
abline(v=0, col="blue")
abline(h=0, col="grey")
legend("topleft","Jul-Sep Catch", bty="n")
...
Yr2 = max(dat$Year)
covnames=c("SST.2.10.3.yr.runsum.0", "SST.UPW.4.mon6to9.0")
covtits =  c("2.5-yr average SST", "Jul-Sep UPW current season")
dat$cov0=dat[["SST.2.10.3.yr.runsum.0"]]
dat$cov1=dat[["SST.UPW.4.mon6to9.0"]]
...
plot(m1, select=3, xlab="2.5-year ave. SST", ylab="Effect")
legend("topright","C", bty="n")
legend("topleft","Oct-Mar Catch", bty="n")
abline(h=0, col="grey")
plot(m2, select=3, xlab="Jun-Sep upwelling index", ylab="Effect")
legend("topright","D", bty="n")
legend("topleft","Oct-Mar Catch", bty="n")
abline(h=0, col="grey")
abline(v=0, col="blue")
...
Yr1 = min(dat$Year)
Yr2 = max(dat$Year)
covnames=c("SST.2.10.3.yr.runsum.0")
covtits =  c("Jul-Sep SST current season")
dat$cov0=dat[["SST.2.10.3.yr.runsum.0"]]
...
plot(m0$model[,"spawners0"],m0$fitted.values, xlim=c(xmin,xmax), ylim=c(xmin,xmax),
     xlab="Log catch in monsoon months", ylab="Predicted log catch\nwithout covariates")
lines(c(xmin,xmax),c(xmin,xmax-jig))
legend("topleft",paste("R2 =",round(100*summary(m0)$r.sq,digits=1)), bty="n")
legend("topright","A", bty="n")

plot(m1$model[,"spawners0"],m1$fitted.values, xlim=c(xmin,xmax), ylim=c(xmin,xmax),
     xlab="Log catch in monsoon months", ylab="Predicted log catch\nwith covariates")
lines(c(xmin,xmax-jig),c(xmin,xmax-jig)) # -jig to keep off legend
legend("topleft",paste("R2 =",round(100*summary(m1)$r.sq,digits=1)), bty="n")
legend("topright","B", bty="n")
...
plot(m0$model[,"nspawners0"],m0$fitted.values, xlim=c(xmin,xmax), ylim=c(xmin,xmax),
     xlab="Log catch in post-monsoon months", ylab="Predicted log catch\nwithout covariates")
lines(c(xmin,xmax-jig),c(xmin,xmax-jig))
legend("topleft",paste("R2 =",round(100*summary(m0)$r.sq,digits=1)), bty="n")
legend("topright","C", bty="n")

plot(m1$model[,"nspawners0"],m1$fitted.values, xlim=c(xmin,xmax), ylim=c(xmin,xmax),
     xlab="Log catch in post-monsoon months", ylab="Predicted log catch\nwith covariates")
lines(c(xmin,xmax-jig),c(xmin,xmax-jig))
legend("topleft",paste("R2 =",round(100*summary(m1)$r.sq,digits=1)), bty="n")
legend("topright","D", bty="n")
