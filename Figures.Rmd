...
dat=seio_covariates_mon[[covname]]
datts=ts(dat,start=1956, frequency=12)
plot(datts,ylab="SST-derived Upwelling Index (deg C)", xlab="",bty="n",ylim=c(-1,5),xlim=c(1980,2020))
legend("topright","A", bty="n")

covname=paste("CHL.",i,sep="")
dat=seio_covariates_mon[[covname]]
datts=ts(dat,start=1956, frequency=12)
plot(datts,ylab="Surface Chlorophyll-a (mg/m^3)", xlab="",bty="n",ylim=c(0,35),xlim=c(1980,2020))
...
dat=seio_covariates_mon[[covname]]
datts=ts(dat,start=1956, frequency=12)
plot(datts,ylab="Average daily precipitation (mm/day)", xlab="",bty="n",ylim=c(0,18),xlim=c(1980,2020))
...
loc=which(dat.spawners$Year %in% years)
...
legend("topleft",paste("R2 =",round(100*summary(m1)$r.sq,digits=1),
                       "RMSE =",round(forecast::accuracy(m1)[,"RMSE"], digits=2),
                       "\nWith multi-year SST "), bty="n")
legend("topright","B", bty="n")
text(m1$model[loc,"spawners0"], m1$fitted.values[loc], labels=years, pos=4, offset=0.3, cex=tcex)
...
legend("topleft",paste("R2 =",round(100*summary(m1)$r.sq,digits=1),
                       ...
                       "\nWith multi-year SST"), bty="n")
legend("topright","D", bty="n")
text(m1$model[loc,"nspawners0"], m1$fitted.values[loc], labels=years, pos=4, offset=0.3, cex=tcex)
