...
covnames = c("precip.gpcp.kerala.mon6to7.", "precip.gpcp.kerala.mon4to5.", "SST.4.mon7to12.", "SST.UPW.4.mon1to3.", "SST.UPW.4.mon7to9.", "SST.UPW.4.mon10to12.")
...
for(covname in c("SST.4.mon7to12.")){
#set up table
...
for(covname in c("SST.UPW.4.mon1to3.", "SST.UPW.4.mon7to9.", "SST.UPW.4.mon10to12.")){
#set up table
  if(covname=="SST.UPW.4.mon10to12.") covtit = "V = Oct-Dec Upwelling"
  if(covname=="SST.UPW.4.mon7to9.") covtit = "V = Jul-Aug Upwelling"
...
if(covname=="SST.UPW.4.mon1to3."){ # Add on model 1 only once
i=1; mod=paste("m",i,sep="")
aa = summary(get(mod))
tmp1=data.frame(Model="$ln(S_t)$ = $\\alpha$ + $s(ln(N_{t-1}))$ + $\\epsilon$",
                Residual.df=round(a[["Resid. Df"]][i],digits=1), Residual.dev=round(a[["Resid. Dev"]][i],digits=2), F="", p.value="", AIC=round(AIC(get(mod)), digits=2))
