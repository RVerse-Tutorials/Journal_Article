...
legend("topright", bty="n", 
       legend=c("No covariates", "DMI only","Precip only"),
...
# val <- valrmse(err.dmi, win=win)
# plot(dat2$Year[ii+win], val[,1], type="l", ylim=c(log(1.1),log(2.5)), lwd=2, ylab="10 year Prediction RMSE", xlab="End year of 10-year window")
# lines(dat2$Year[ii+win], val[,2], col="red", lwd=2)
# val <- valrmse(err.precip, win=win)
# lines(dat2$Year[ii+win], val[,2], col="grey", lwd=3)
# legend("topright", bty="n", 
