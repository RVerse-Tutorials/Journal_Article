...
respdat=data.frame(
  ...
  catchq4.0=oilsardine_qtr[[reg]][oilsardine_qtr$Qtr==4]
  )
...
covnames = c("precip.gpcp.kerala.mon6to7.", "precip.gpcp.kerala.mon4to5.",
             ...
             "SST.4.mon8to9.", "SST.4.mon9to10.", 
             "SST.UPW.4.mon1to3.", "SST.UPW.4.mon7to9.",
             "SST.UPW.4.mon10to12.", "SST.UPW.4.mon4to6.")
#set up to use consistent data
dat=fullrespdat[,c("Year","spawners0", "catchq4.0", "nspawners1", paste(covnames, "0", sep=""), paste(covnames, "1", sep=""))]
dat=na.omit(dat)
dat.spawners=dat
...
```{r message=FALSE,warning=FALSE, echo=FALSE}
covnames = c("precip.gpcp.kerala.mon6to7.", "precip.gpcp.kerala.mon4to5.",
             "SST.4.mon11to12.", "SST.4.mon1to9.", 
             "SST.4.mon7to9.", "SST.4.mon7to12.", "SST.4.mon8to9.",
             "SST.UPW.4.mon1to3.", "SST.UPW.4.mon7to9.",
             "SST.UPW.4.mon10to12.", "SST.UPW.4.mon4to6.",
             "SST.UPW.4.mon11to12.", "SST.UPW.4.mon10to11.",
             "SST.UPW.4.mon5to6.")
#set up to use consistent data
dat=fullrespdat[,c("Year","nspawners0", "catchq4.0", "Catch1", "Catch2",
                   "nspawners1", "spawners2", paste(covnames, "0", sep=""), paste(covnames, "1", sep=""))]
dat=na.omit(dat)
dat.nonspawners=dat
...
#set up to use consistent data
dat=fullrespdat[,c("Year", "spawners0", "catchq4.0", "nspawners0", "nspawners1", "spawners2", paste(covnames, "0", sep=""), paste(covnames, "1", sep=""))]
dat=na.omit(dat)
dat.chl=dat
