...
for(i in 1:length(covnames)){
  ...
  covdat=tapply(seio_covariates_mon2[[covname]],seio_covariates_mon2$Year,function(x){max(x[mon],na.rm=TRUE)})
...
respdat$spawner0mnspawner1=respdat$spawner0-respdat$nspawner1
respdat$nspawner0mnspawner1=respdat$nspawner0-respdat$nspawner1
...
covnames = c("precip.gpcp.kerala.mon6to7.", "precip.gpcp.kerala.mon4to5.", 
             "SST.4.mon1to12.", "SST.4.mon1to9.", "SST.4.mon7to9.", 
             "SST.4.mon4to6.","SST.4.mon1to3.",
             "SST.UPW.4.mon1to3.", "SST.UPW.4.mon7to9.", 
...
covnames = c("log.CHL.4.mon1to3.", "log.CHL.4.mon7to9.", "log.CHL.4.mon10to12.",
             ...
             "SST.UPW.4.mon1to3.", "SST.UPW.4.mon7to9.", 
             "SST.UPW.4.mon10to12.", "SST.UPW.4.mon4to6.",
             "SST.UPW.5.mon1to3.", "SST.UPW.5.mon7to9.", 
             "SST.UPW.5.mon10to12.", "SST.UPW.5.mon4to6.",
             "SST.4.mon7to9.", 
             "SST.4.mon10to12.", 
             "SST.5.mon7to9.", 
             "SST.5.mon10to12.")
