...
```{r message=FALSE, warning=FALSE, echo=FALSE}
  covnames=c(
   ...
   "ONI","DMI","Bakun.UPW", "tide.level.interp", "anomalies")
  covmon=list(
...
for(varn in c("SST.", "DMI", "Precip.Kerala")){
  if(varn=="SST.") ivals <- c("2.5", "2.10", "7.10", "7.13", "11.13", "1.13")
...
covnames = c("precip.gpcp.kerala.mon6to7.", "precip.gpcp.kerala.mon4to5.", 
             ...
             "tide.level.interp.mon6to7.", 
             "tide.level.interp.mon7to8.", 
             "tide.level.interp.mon8to8.",
             "tide.level.interp.mon9to9.", 
             "anomalies.mon6to9.", "DMI.3.yr.runsum.", "Precip.Kerala.3.yr.runsum.")
```
