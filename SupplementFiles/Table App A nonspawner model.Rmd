...
thecap=paste0("Table ",ref(paste0(tabset,"nonspawner-model-time-b"), pre=pre), " with 1956-",Yr1-1, " data instead of ", Yr1, " to ", Yr2, " data.  The years used in fit start in 1958 since $t-2$ (which is 1956 for the 1958 data point) is used in the covariates. See Table ",ref(paste0(tabset,"nonspawner-model-time-a"), pre=pre), " for an explanation of the parameters and model set-up.")
