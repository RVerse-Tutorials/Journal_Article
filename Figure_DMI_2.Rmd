...
#RMSE plot
err.dmi <- rbind(null=dat2$resid, dmi=(fitted(fit.dmi, type="ytt1")$.fitted-dat2$resid))
err.dmi.precip <- rbind(null=dat2$resid, 
               dmi=(fitted(fit.dmi.precip, type="ytt1")$.fitted-dat2$resid))
err.precip <- rbind(null=dat2$resid, 
               dmi=(fitted(fit.precip, type="ytt1")$.fitted-dat2$resid))
