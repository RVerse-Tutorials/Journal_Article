...
res <- resinf2(resfun="aicc", type="s1956")
...
res <- resinf2(resfun="aicc", type="s1984")
...
p1 <- p + scale_color_manual( values = c( Actual="black", `One step ahead`="blue")) +  labs(color="") + xlab('') +  ylab('Jul-Sep Catch') + theme_classic() + theme(
...
fit <- myfits[[1]]
p <- ggplot() + geom_point(data=fit$data, aes(x=Year, y=resp, color="Actual"))
nullmods = stringr::str_detect(names(myfits),"null")
...
p4 <- p + scale_color_manual( values = c( Actual="black", `One step ahead`="blue")) +  labs(color="") + xlab('') +  ylab('Jul-Sep Catch') + theme_classic() + theme(
  legend.justification = c(1,0), legend.position = c(1,0),
  legend.key = element_rect(colour = "transparent", fill = "white"))
grob <- grobTree(textGrob("Null models", x=0.1,  y=0.95, hjust=0, gp=gpar(col="blue", fontsize=13)))
p4 <- p4 + annotation_custom(grob)
grob <- grobTree(textGrob("D", x=0.05,  y=0.1, hjust=0, gp=gpar(col="black", fontsize=13)))
p4 <- p4 + annotation_custom(grob)
...
res <- resinf2(resfun="aicc", type="ns1956")
...
res <- resinf2(resfun="aicc", type="ns1984")
