...
kable(seltable, align="lccccc", caption="Table A1a. F-tests of nested models of the time-dependency of the catch in Qtr 3 using the full catch data (1956-2015) or only the data that overlap with the satellite covariate data (1982-2015).  See Table 1 for definitions.")
```
...
colnames(seltable)=c("Model", "Residual df", "Residual deviance", "F", "p value", "AIC")
kable(seltable, align="lccccc", caption="Table A1b. F-tests of nested models of the linearity of the catch in Qtr 3 using the full catch data (1956-2015) or only the data that overlap with the satellite covariate data (1982-2015).  See Table 1 for definitions.")
```