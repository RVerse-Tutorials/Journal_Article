...
Yr1 = min(dat$Year)
Yr2 = max(dat$Year)
covnames=c("SST.4.mon6to9.0", "SST.4.mon9to10.1")
covtits =  c("Jun-Sep SST current season", "Oct-Dec SST prior season")
dat$cov0=dat[["SST.4.mon6to9.0"]]
dat$cov1=dat[["SST.4.mon9to10.1"]]
...
Yr2 = max(dat$Year)
covnames=c("SST.4.mon6to9.0", "SST.4.mon9to10.1")
covtits =  c("Jun-Sep SST current season", "Sep-Oct SST prior season")
dat$cov0=dat[["SST.4.mon6to9.0"]]
dat$cov1=dat[["SST.4.mon9to10.1"]]
...
tmp2 = data.frame(Model="$V_t$ = Jun-Sep SST current season", Residual.df="", Residual.dev="", F="", p.value="", AIC="", stringsAsFactors = FALSE)
tmp3 = data.frame(Model="$W_{t-1}$ = Sep-Oct SST prior season", Residual.df="", Residual.dev="", F="", p.value="", AIC="", stringsAsFactors = FALSE)
...
Yr1 = min(dat$Year)
Yr2 = max(dat$Year)
covnames=c("SST.4.mon6to9.0", "SST.UPW.4.mon10to12.1")
covtits =  c("Jun-Sep SST current season", "Oct-Dec UPW prior season")
dat$cov0=dat[["SST.4.mon6to9.0"]]
dat$cov1=dat[["SST.UPW.4.mon10to12.1"]]
...
## Header
tmp1 = data.frame(Model="Oct-Mar catch models with covariates", Residual.df="", Residual.dev="", F="", p.value="", AIC="", stringsAsFactors = FALSE)
tmp2 = data.frame(Model="$V_t$ = Jun-Sep SST current season", Residual.df="", Residual.dev="", F="", p.value="", AIC="", stringsAsFactors = FALSE)
