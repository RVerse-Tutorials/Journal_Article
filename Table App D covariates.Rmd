...
rmyr <- c(1987)
Palette4 <- c("#000000", "#009E73", "#F0E442", "#D55E00")
```

## Validation of the Jul-Sep landings base models

To evaluate the environmental covariates, GAM and linear models were fit leaving one year out (year shown on the x-axis). The far right shows the fit to all years. 
...
p + theme(axis.text.x = element_text(angle = 90, vjust=0.5, hjust=1), aspect.ratio = 4/3) + scale_fill_manual(values=Palette4)
```
